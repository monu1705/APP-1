...
export const UpiIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m12 12 4-4"/><path d="m16 12-4-4"/><path d="m12 12 4 4"/><path d="m16 12 4 4"/><path d="m12 12-4 4"/><path d="m8 12-4 4"/><path d="M20 12h-4"/><path d="m4 12h4"/><circle cx="12" cy="12" r="10"/>
  </svg>
);

export const BankIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m3 21 18-0" /><path d="M5 21V10l7-5 7 5v11" /><path d="M12 21V10" /><path d="m12 5-2 2" /><path d="m14 7 2-2" /><path d="m9 14 6 0" />
  </svg>
);
...
export const GoogleDriveIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M7.71 6.5L1.15 17h4.68l6.56-10.5H7.71zm9.58 0L6.65 17h13.7l2.14-3.5H17.29zm-1.42 2.28L17.5 13h-3.85l2.14-4.22z"/>
    </svg>
);
